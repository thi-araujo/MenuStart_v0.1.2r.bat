...
set apps="src\apps\screen\*" "%public%\Desktop"
set shortcuts="src\desktop\users\atalhos\*" "%public%\Desktop"
set icon="src\desktop\users\icones\*" "%public%\icones"
set map="src\scripts\networkMapping\*" "%public%\Desktop"
set urls="src\desktop\users\urls\*" "%public%\Desktop"
